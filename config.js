...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "SUBZERO~5165f69c8834c9974e9c2bab4dded40856307031",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "2349037241013",  // Owner's WhatsApp number
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "Darknet",           // Owner's name
    ...
    ANTI_DEL_PATH: process.env.ANTI_DEL_PATH || "same",          // Log deleted messages (or 'same' to resend)
